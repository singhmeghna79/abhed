...
not triaged, or appears there more often than before.
    ...
    python3 deploy/ci/gosec-gate.py gosec.json            # check
    python3 deploy/ci/gosec-gate.py gosec.json --update   # after triaging
...
def main():
    ...
    if new:
        ...
        for k, v in sorted(new.items()):
            print(f"  +{v}  {k}")
        print("Triage them in docs/trust/security-scans.md, then: python3 deploy/ci/gosec-gate.py gosec.json --update")
        return 1
